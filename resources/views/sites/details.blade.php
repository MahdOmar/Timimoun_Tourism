  ...
  <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
    ...
    <div class="lg:col-span-2 bg-white p-6 rounded-lg shadow">
      ...
      @if($site->gallery && $site->gallery->count() > 0)
        <h2 class="text-2xl font-semibold text-gray-800 mt-10 mb-6">{{ __('messages.site.details.gallery') }}</h2>
      ...
      @if(isset($relatedSites) && $relatedSites->count() > 0)
        <h2 class="text-2xl font-semibold text-gray-800 mt-12 mb-6">{{ __('messages.site.details.related') }}</h2>
    ...
    <div class="space-y-6">
      ...
      <!-- Contact (Optional) -->
      <div class="bg-white shadow rounded-lg p-6">
        <h3 class="text-lg font-semibold text-gray-800 mb-4">{{ __('messages.site.details.help') }}</h3>
        <p class="text-sm text-gray-600 mb-2">{{ __('messages.site.details.text') }}</p>
        <p class="text-sm font-medium text-gray-800">{{ __('messages.site.details.office') }}</p>
