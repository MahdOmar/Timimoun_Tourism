...
<div class="bg-white">
  <div class="main max-w-screen-xl mx-auto py-20 bg-white">
    <div class="popular">
      ...
      <div class="list grid grid-cols-4 gap-4">
        ...
        <div class="shadow-md hover:shadow-lg transition-all relative">
          ...
          <div class="bg-white min-h-80 p-2">
            <div class="overflow-hidden h-80">
              <div class="block h-full relative before:block before:absolute before:bg-black before:h-full before:w-full before:top-0 before:z-20 before:opacity-45">
                <img src="{{ asset('./images/hotel-oasis-rouge.jpg') }}" alt="" class="absolute top-0 h-full w-full object-cover">
              </div>
            </div>
          </div>
          <div class="flex items-center flex-col justify-center pb-5 pt-2 relative">
            ...
            <h3 class="text-2xl font-bold text-slate-600 mb-1">RED OASIS HOTEL</h3>
      ...
      <div class="group shadow-md hover:shadow-lg bg-white grid grid-cols-2">
        <div class="relative h-80">
          <div class="absolute bg-rose-500 py-2 pr-3 pl-6 mt-6 text-white">
            <span class="font-bold text-xl">7.500 DA</span> <span class="text-xs text-stone-200">/ persone</span>
          </div>
          <img src="{{ asset('./images/gourara.jpg') }}" alt="" class="h-full object-cover">
        ...
        <div class="p-10 relative">
          ...
          <h2 class="font-bold text-2xl text-slate-800 mb-6 group-hover:text-rose-600">GOURARA HOTEL</h2>
